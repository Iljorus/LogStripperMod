...
/*
 * ItemStackHandler wrapper that allows for normal item manipulation except only allows specific items in its slot
 * */
public class SpecialItemStackWrapper extends ItemStackHandler {
    private final ItemStackHandler internalHandler;

    public SpecialItemStackWrapper(ItemStackHandler internalHandler) {
        super();
